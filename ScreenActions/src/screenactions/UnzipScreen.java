...
public class UnzipScreen {
    ...
    public void start(Stage primary,String text) throws MalformedURLException{
       ...
       // HnButtons.setStyle("-fx-border-style: solid inside;");
        ...
        Label step1= new Label("Step 3:Unzip Student Submissions");
        step1.setStyle("-fx-font-size:20;");
 
        Label explanation=new Label("Select student submissions and click Unzip");
       ...
       String file1="BigD/"+text+"/submissions";
        ...
        Label extractL= new Label("Unzip Progress");
        ...
        Button extractButton= new Button("Unzip");
        ...
        TableColumn blackboardSub= new TableColumn("Student ZIP files");
       ...
       // tableContainer.setPadding(new Insets(10,0,0,0));
        ...
        TableColumn successColumn= new TableColumn("Successfully unzipped files");
